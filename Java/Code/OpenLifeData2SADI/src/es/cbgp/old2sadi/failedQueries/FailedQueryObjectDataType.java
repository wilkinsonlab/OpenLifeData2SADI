...
public class FailedQueryObjectDataType extends FailedQuery {

	private Resource associatedSubject;
	private Resource associatedPredicate;

	public FailedQueryObjectDataType(File ffq, String q, Endpoint e, int t, long s, MyLogger l, String err, 
			Resource as, Resource ap) {
		super(ffq, q, e, t, s, l, err);
		this.associatedSubject = as;
		this.associatedPredicate = ap;
	}
	public FailedQueryObjectDataType(String q, Endpoint e, int t, long s, MyLogger l, String err, 
			Resource as, Resource ap) {
		super(q, e, t, s, l, err);
		this.associatedSubject = as;
		this.associatedPredicate = ap;
	...
	public String getHash() {
		String sHash = this.getEndpoint().getName() + this.getAssociatedSubject().toString() + this.getAssociatedPredicate().toString() + this.getType() + this.getSeed() + "DT";
